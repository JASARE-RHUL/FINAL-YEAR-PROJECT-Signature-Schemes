...
/**
 * A utility class that provides static methods for common display operations
 * such as showing
 * alerts, copying text to clipboard, and handling file imports within the
 * application.
 */
public class DisplayUtility {

  /**
   * Handles the file import operation used by both text and key import
   * functionalities. It prompts
   * the user to choose a file and then applies the provided fileConsumer to
   * the selected file.
   *
   * @param stage        The stage used to show the file chooser dialog.
   * @param extension    The file extension filter description used in the
   *                     file chooser.
   ...
   * @param asset The name of the asset to be displayed in the confirmation
   *              alert.
   */
  protected static void copyToClipboard(String text, String asset) {
    ...
    showInfoAlert("Clipboard", asset + " was successfully copied to " +
      "clipboard!");
  }
   ...
   */
  protected static void showAlert(AlertType type, String title,
                                  String content) {
  ...
  /**
   * Shows a progress dialog indicating the progress of an ongoing
  ...
  protected static Dialog<Void> showProgressDialog(Stage primaryStage,
    ...
    VBox dialogContent = new VBox(10, new Label("Processing..."), progressBar
      , progressLabel);
