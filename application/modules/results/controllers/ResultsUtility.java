...
/**
 * Provides utility functions to support the handling and processing of
 * benchmarking results. It is
 * to be used in contexts where results need to be organised or manipulated
...
public class ResultsUtility {
  ...
  /**
   * Calculates and returns the length of a key for a given key size index.
   * This method is
   * particularly useful in comparison mode benchmarking, where it helps in
   * determining the key
   * length corresponding to a specific index within a set of results models.
   *
   * @param keySizeIndex                 The index of the key size whose
   *                                     length is to be
   *                                     determined.
   * @param resultsModels                The list of ResultsModel objects
   *                                     containing benchmarking
   *                                     data.
   * @param numKeySizesForComparisonMode The number of key sizes selected for
   *                                    comparison mode.
   * @param keyLengths                   The list of integers representing
   *                                     key lengths.
   * @return The key length corresponding to the specified key size index.
   */
  public static int getKeyLength(int keySizeIndex,
