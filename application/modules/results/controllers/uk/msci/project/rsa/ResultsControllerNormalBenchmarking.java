 ...
 * benchmarking application in standard benchmarking mode based solely on the results ordered by
 * single keys. It integrates the results view and model, handles the generation of result
