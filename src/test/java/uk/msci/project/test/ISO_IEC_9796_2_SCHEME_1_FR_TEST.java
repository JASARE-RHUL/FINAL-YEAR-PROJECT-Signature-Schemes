...
public class ISO_IEC_9796_2_SCHEME_1_FR_TEST {

  private ISO_IEC_9796_2_SCHEME_1_FR scheme;

  @BeforeEach
  public void setup() {
    scheme = new ISO_IEC_9796_2_SCHEME_1_FR(
  ...
  void testInitialBytePadding() throws Exception {
    ...
    assertEquals(0x4A, encodedMessage[1],
  ...
  void testMessagePlacement() throws Exception {
    ...
    Method encodeMethod = ISO_IEC_9796_2_SCHEME_1_FR.class.getMethod("encodeMessage", byte[].class);
    encodeMethod.setAccessible(true);
